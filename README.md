...
- 需要翻墙的机器，手动设置网关和DNS为树莓派的ip。树莓派作为透明翻墙网关，只要是连接到这个网关的设备，自动翻墙，无需再安装设置翻墙软件。
...
>wget https://github.com/Dreamacro/clash/releases/download/premium/clash-linux-armv7-2023.05.29.gz 
